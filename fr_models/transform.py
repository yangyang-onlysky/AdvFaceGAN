...
from fr_models.DiffJPEG.compression import compress_jpeg
from fr_models.DiffJPEG.decompression import decompress_jpeg
from fr_models.DiffJPEG.utils import quality_to_factor
import random
class DiffJPEG(nn.Module):
    ...
    def __init__(self, quality=80):
        ...
        from fr_models.DiffJPEG.utils import diff_round
        rounding = diff_round
