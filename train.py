...
def main(args):
    ...
    if args.sourceadvlossfactor is not None:
        config.set('Train', 'source_adv_loss_factor', str(args.sourceadvlossfactor))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--pert', help='Lower limit of perturbation', type=float, default=None)
    ...
    parser.add_argument('--sourceadvlossfactor', help="source adv loss's factor'", type=float, default=None)
