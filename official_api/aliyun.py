...
if __name__ == '__main__':
    ...
    # batch_add_face('test', 0, [
    #     r'C:\yy\source\Desktop\advWebsite\sample\advs\41.png',
    # ])
    # delete_face('test', 163929891)
    # delete_face_entity('test',3)
    # delete_face_db('test')
    # clear_db('test')
    # upload_db('test', r'C:\yy\datasets\debug')

    # result = face_compare(face1_path=r"C:\yy\datasets\505\505-aligned-112x112\gj\1.png",
    #                       face2_path=r"C:\yy\datasets\505\505-aligned-112x112\yy\1.png")

    result = search_face(face_path=r"C:\yy\datasets\505\505-aligned-112x112\yy\2.png", dbName='test')
    #
    json_print(result)
    pass